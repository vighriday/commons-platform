...
import { HSR_CELLS, PLANTED_CELLS, cellByKey, seededJitter } from "../seed/plusCodes.ts";
import type { Category, MediaItem, Report, Reporter } from "../shared/types.ts";
...
const REPORTERS: Reporter[] = [
  {
    id: "U01",
    handle: "HSR_Citizen_Watch",
    displayName: "HSR Citizen Watch",
    adminLevel: "ngo",
    adminLevelScore: 0.8,
    homeCell: cellByKey("main27_s1").plusCellId,
    reportCount: 0,
  },
  {
    id: "U02",
    handle: "AgaraLakeVolunteers",
    displayName: "Agara Lake Volunteers",
    adminLevel: "ngo",
    adminLevelScore: 0.8,
    homeCell: cellByKey("agara_lake").plusCellId,
    reportCount: 0,
  },
  {
    id: "U03",
    handle: "Ward174_RWA",
    displayName: "Ward 174 RWA",
    adminLevel: "verified",
    adminLevelScore: 0.6,
    homeCell: cellByKey("main14_s3").plusCellId,
    reportCount: 0,
  },
...
function media(
  ...
  caption: string | null,
  extracted: MediaItem["extracted"] = null,
): MediaItem[] {
  return [
    { type, ref: type === "none" ? null : `seed/photos/placeholder.svg`, caption, extracted },
  ];
}
...
function add(
  r: Omit<Report, "wardId" | "embeddingId" | "seed"> & { plantedPatternId?: string | null },
): void {
...
add({
  reportId: "R041",
  category: "water",
  text: "Water pressure very low past few days in 27th Main, second tap barely runs in morning.",
  createdAt: iso("2025-02-11T09:14:00"),
  reporterId: "U05",
  location: locFor("main27_s1", "R041"),
  media: media("none", null),
  engagement: { upvotes: 1, replies: 0, viewCount: 8 },
  alarmIntensity: 0.22,
  isGenuine: true,
  spamScore: 0.02,
...
add({
  reportId: "R058",
  category: "roads",
  text: "Small depression forming on road near 27th Main / 5th Cross junction, getting bigger.",
...
add({
  reportId: "R072",
  category: "water",
  text: "Brown / rusty water from tap on Tuesday morning, cleared by evening.",
  createdAt: iso("2025-05-09T07:55:00"),
  reporterId: "U12",
  location: locFor("main27_s1", "R072"),
  media: media("none", null),
  engagement: { upvotes: 1, replies: 0, viewCount: 6 },
  alarmIntensity: 0.25,
  isGenuine: true,
  spamScore: 0.02,
  plantedPatternId: "synthesis",
...
add({
  reportId: "R086",
  category: "drainage",
  text: "Patch of road stays wet even when no rain for 3 days, near the depression.",
  createdAt: iso("2025-07-02T21:10:00"),
  reporterId: "U05",
  location: locFor("main27_s1", "R086"),
  media: media("none", null),
  engagement: { upvotes: 0, replies: 0, viewCount: 4 },
  alarmIntensity: 0.2,
  isGenuine: true,
  spamScore: 0.02,
  plantedPatternId: "synthesis",
...
add({
  reportId: "R033",
  category: "drainage",
  text: "Drain near Agara Lake Rd full of silt and plastic, water not moving.",
...
add({
  reportId: "R077",
  category: "waste",
  text: "Garbage dumped in the storm drain again on Agara Lake Rd.",
  createdAt: iso("2025-05-30T16:20:00"),
  reporterId: "U14",
  location: locFor("agara_lake", "R077"),
  media: media("none", null),
  engagement: { upvotes: 0, replies: 0, viewCount: 5 },
  alarmIntensity: 0.16,
  isGenuine: true,
  spamScore: 0.04,
  plantedPatternId: "hiddenCrisis1",
...
add({
  reportId: "R064",
  category: "structural",
  text: "Crack running up the wall of the building near Somasundarapalya Main Rd, getting longer.",
  ...
  isGenuine: true,
  spamScore: 0.03,
  plantedPatternId: "hiddenCrisis2",
});
// HC-3 (streetlight blackout, ORR) — 2 reports
add({
  reportId: "R049",
  category: "streetlights",
  text: "Streetlights off again on ORR service road near bus stop, very dark.",
  createdAt: iso("2025-02-28T19:50:00"),
  reporterId: "U11",
  location: locFor("orr_service", "R049"),
  media: media("none", null),
  engagement: { upvotes: 1, replies: 0, viewCount: 10 },
  alarmIntensity: 0.22,
  isGenuine: true,
  spamScore: 0.02,
...
add({
  reportId: "R069",
  category: "streetlights",
  text: "Still no streetlights on the ORR service road stretch, unsafe walking at night.",
  createdAt: iso("2025-04-29T20:15:00"),
  reporterId: "U19",
  location: locFor("orr_service", "R069"),
  media: media("none", null),
  engagement: { upvotes: 1, replies: 1, viewCount: 12 },
  alarmIntensity: 0.22,
  isGenuine: true,
  spamScore: 0.02,
  plantedPatternId: "hiddenCrisis3",
...
add({
  reportId: "R028",
  category: "drainage",
  text: "Drain overflowing onto road at 14th Main 1st Cross, sewage smell.",
  createdAt: iso("2025-01-08T11:00:00"),
  reporterId: "U03",
  location: locFor("main14_s3", "R028"),
  media: media("none", null),
  engagement: { upvotes: 3, replies: 1, viewCount: 20 },
  alarmIntensity: 0.3,
  isGenuine: true,
  spamScore: 0.02,
...
add({
  reportId: "R055",
  category: "drainage",
  text: "Same drain at 14th Main overflowing again, third time this season.",
  createdAt: iso("2025-03-21T17:30:00"),
  reporterId: "U03",
  location: locFor("main14_s3", "R055"),
  media: media("voice", "voice note: drain floods every monsoon, third year now", null),
  engagement: { upvotes: 4, replies: 2, viewCount: 25 },
  alarmIntensity: 0.27,
  isGenuine: true,
  spamScore: 0.02,
  plantedPatternId: "recurrence",
...
add({
  reportId: "R083",
  category: "drainage",
  text: "Drain at 14th Main 1st Cross blocked and overflowing yet again, monsoon starting.",
  createdAt: iso("2025-06-19T09:40:00"),
  reporterId: "U08",
  location: locFor("main14_s3", "R083"),
  media: media("none", null),
  engagement: { upvotes: 5, replies: 2, viewCount: 30 },
  alarmIntensity: 0.27,
  isGenuine: true,
  spamScore: 0.02,
  plantedPatternId: "recurrence",
...
potholeIds.forEach((id, i) => {
  add({
    ...
    category: "roads",
    text: potholeTexts[i],
    createdAt: iso(potholeDates[i]),
    reporterId: i === 0 ? "U01" : pick(REPORTERS.slice(3)).id,
...
add({
  reportId: "R090",
  category: "drainage",
  text: "Drain blocked near 100ft Road, water pooling on the road edge.",
  createdAt: iso("2026-04-12T10:00:00"),
  reporterId: "U07",
  location: locFor("road100ft", "R090"),
  media: media("none", null),
  engagement: { upvotes: 2, replies: 0, viewCount: 12 },
  alarmIntensity: 0.28,
  isGenuine: true,
  spamScore: 0.02,
...
add({
  reportId: "R093",
  category: "drainage",
  text: "Same 100ft Road drain overflowing again after light rain.",
  createdAt: iso("2026-05-18T14:30:00"),
  reporterId: "U10",
  location: locFor("road100ft", "R093"),
  media: media("none", null),
  engagement: { upvotes: 3, replies: 1, viewCount: 16 },
  alarmIntensity: 0.3,
  isGenuine: true,
  spamScore: 0.02,
  plantedPatternId: "liveDemo",
...
add({
  reportId: "R095",
  category: "other",
  text: "Best plumbing service in HSR!! Call 99999 99999 for 50% off!!!",
  createdAt: iso("2026-03-02T13:00:00"),
  reporterId: "U20",
  location: locFor("bda_complex", "R095"),
  media: media("none", null),
  engagement: { upvotes: 0, replies: 0, viewCount: 3 },
  alarmIntensity: 0.4,
  isGenuine: false,
  spamScore: 0.92,
  plantedPatternId: "spam",
});
add({
  reportId: "R096",
  category: "other",
  text: "asdf test test ignore",
  createdAt: iso("2026-02-14T09:00:00"),
  reporterId: "U21",
  location: locFor("bda_park", "R096"),
  media: media("none", null),
  engagement: { upvotes: 0, replies: 0, viewCount: 1 },
  alarmIntensity: 0.1,
  isGenuine: false,
  spamScore: 0.75,
  plantedPatternId: "spam",
...
const fillerPhrases: Record<Category, string[]> = {
  roads: [
    "Pothole near {s}.",
    "Road surface cracking on {s}.",
    "Uneven patch repair on {s}.",
    "Speed bump worn out near {s}.",
  ],
  water: [
    "Low water pressure on {s}.",
    "Tap water muddy on {s} this week.",
    "Pipe leak on the footpath at {s}.",
    "No water supply since morning on {s}.",
  ],
  drainage: [
    "Drain slow to clear on {s}.",
    "Minor water pooling at {s}.",
    "Drain cover loose near {s}.",
    "Blocked gutter on {s}.",
  ],
  waste: [
    "Garbage not collected on {s}.",
    "Bin overflowing at {s}.",
    "Litter piling near {s}.",
    "Mixed waste dumped at {s}.",
  ],
  streetlights: [
    "One streetlight out on {s}.",
    "Flickering light near {s}.",
    "Dark patch on {s} at night.",
    "Streetlight pole leaning on {s}.",
  ],
  structural: [
    "Cracked compound wall near {s}.",
    "Loose plaster on culvert at {s}.",
    "Damaged footpath slab on {s}.",
  ],
  parks: [
    "Overgrown bushes in park near {s}.",
    "Broken bench at {s} park.",
    "Dead tree branch over path at {s}.",
  ],
  traffic: [
    "Faded zebra crossing at {s}.",
    "Missing signboard near {s}.",
    "Signal timing too short at {s}.",
  ],
...
const bgCells = HSR_CELLS.filter(
  (c) =>
    ![
      PLANTED_CELLS.synthesis,
      PLANTED_CELLS.hiddenCrisis1,
      PLANTED_CELLS.hiddenCrisis2,
      PLANTED_CELLS.hiddenCrisis3,
      PLANTED_CELLS.recurrence,
      PLANTED_CELLS.noise,
      PLANTED_CELLS.liveDemo,
    ]
      .map((k) => cellByKey(k).plusCellId)
      .includes(c.plusCellId),
);
const months = [
  "2024-12",
  "2025-01",
...
for (const cat of [
  ...
  assert(
    tally[cat] === TARGET[cat],
    `category ${cat}: expected ${TARGET[cat]}, got ${tally[cat] ?? 0}`,
  );
}
...
const expGrid = JSON.parse(readFileSync(path.join(SEED_DIR, "exposureGrid.json"), "utf8")) as {
  plusCellId: string;
}[];
const gridCells = new Set(expGrid.map((c) => c.plusCellId));
for (const r of reports) {
  assert(
    gridCells.has(r.location.plusCellId),
    `report ${r.reportId} cell ${r.location.plusCellId} missing from exposureGrid`,
  );
}
...
// eslint-disable-next-line no-console
console.log(
  `[genSeed] OK — wrote ${reports.length} reports, ${REPORTERS.length} reporters. Category tally:`,
  tally,
);
