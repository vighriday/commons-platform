...
export const AUTHORITY_MAP: Record<Category, Authority> = {
  drainage: {
    ...
    slaDays: 15,
    costBand: "₹2L–₹10L",
    citations: ["BBMP SWD owns stormwater drains and desilting", "Ward 174 falls under BBMP Bommanahalli zone"],
  },
  water: {
    dept: "Bangalore Water Supply & Sewerage Board (BWSSB)",
    officialRole: "Assistant Executive Engineer, BWSSB Sub-division",
    contact: { phone: "1916", email: "complaints@bwssb.gov.in", portal: "https://bwssb.karnataka.gov.in" },
    jurisdictionAdminLevel: "utility",
    slaDays: 7,
    costBand: "₹5L–₹25L",
    citations: ["BWSSB owns trunk water mains + supply", "Trunk-main failure is a parastatal, not BBMP, jurisdiction"],
  },
  structural: {
    ...
    slaDays: 3,
    costBand: "₹1L–₹50L+",
    citations: ["Building safety / load-bearing defects = BBMP TVCC", "Life-safety items carry an expedited SLA"],
  },
  streetlights: {
    dept: "BESCOM (Bangalore Electricity Supply Company)",
    officialRole: "Section Officer, BESCOM HSR sub-division",
    contact: { phone: "1912", email: "feedback@bescom.co.in", portal: "https://bescom.karnataka.gov.in" },
    jurisdictionAdminLevel: "utility",
    slaDays: 5,
    costBand: "₹20k–₹2L",
    citations: ["BESCOM owns street-light feeders + maintenance", "Pedestrian-risk blackouts are priority-routed"],
  },
  roads: {
  ...
  parks: {
    ...
    contact: { phone: "080-23440000", email: "horticulture@bbmp.gov.in", portal: "https://bbmp.gov.in" },
    jurisdictionAdminLevel: "zone",
    slaDays: 20,
    costBand: "₹50k–₹5L",
  ...
  traffic: {
    ...
    contact: { phone: "080-22942222", email: "dcptr.east@ksp.gov.in", portal: "https://btp.gov.in" },
    jurisdictionAdminLevel: "city",
    slaDays: 7,
    costBand: "₹10k–₹2L",
